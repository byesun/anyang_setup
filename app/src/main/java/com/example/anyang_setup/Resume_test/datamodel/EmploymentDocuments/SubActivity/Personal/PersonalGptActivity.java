...
import com.example.anyang_setup.Resume_test.datamodel.EmploymentDocuments.SubActivity.Chat_gpt.Chat_Message;
import com.example.anyang_setup.Resume_test.datamodel.EmploymentDocuments.SubActivity.Chat_gpt.Chat_MessageAdapter;
...
public class PersonalGptActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messageAdapter = new Chat_MessageAdapter(messageList);
    ...
    void addToChat(String message, String sentBy){
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                messageList.add(new Chat_Message(message, sentBy));
    ...
    void callAPI(String question){
        //okhttp
        messageList.add(new Chat_Message("답변 생성중...", Chat_Message.SENT_BY_BOT));
